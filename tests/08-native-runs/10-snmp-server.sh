...
## snmpwalk - pass
test_handler "snmpwalk -t2 -v1 -c public udp6:[$IPADDR]:161 1" "iso\.3\.6\.1\.2\.1\.1\.1\.0.*iso\.3\.6\.1\.2\.1\.1\.2\.0.*iso\.3\.6\.1\.2\.1\.1\.3\.0.*iso\.3\.6\.1\.2\.1\.1\.4\.0.*iso\.3\.6\.1\.2\.1\.1\.5\.0.*iso\.3\.6\.1\.2\.1\.1\.6\.0.*iso\.3\.6\.1\.2\.1\.1\.7\.0.*iso\.3\.6\.1\.4\.1\.2021\.14\.1\.1\.2\.0.*End of MIB"

## snmpget - pass - before snmpset  
test_handler "snmpget -t2 -v1 -c public udp6:[$IPADDR]:161 1.3.6.1.4.1.2021.14.1.1.2.0" ".*iso\.3\.6\.1\.4\.1\.2021\.14\.1\.1\.2\.0.*BeforeSet.*"  
## snmpset - pass - after snmpget
test_handler "snmpset -t2 -v1 -c public udp6:[$IPADDR]:161 1.3.6.1.4.1.2021.14.1.1.2.0 s AfterSet" ".*iso\.3\.6\.1\.4\.1\.2021\.14\.1\.1\.2\.0.*AfterSet.*"
## snmpget - pass - after snmpset
test_handler "snmpget -t2 -v1 -c public udp6:[$IPADDR]:161 1.3.6.1.4.1.2021.14.1.1.2.0" ".*iso\.3\.6\.1\.4\.1\.2021\.14\.1\.1\.2\.0.*AfterSet.*"
## snmpset - pass - restore default
test_handler "snmpset -t2 -v1 -c public udp6:[$IPADDR]:161 1.3.6.1.4.1.2021.14.1.1.2.0 s BeforeSet" ".*iso\.3\.6\.1\.4\.1\.2021\.14\.1\.1\.2\.0.*BeforeSet.*"
...
## snmpwalk - pass
test_handler "snmpwalk -t2 -v2c -c public udp6:[$IPADDR]:161 1" "iso\.3\.6\.1\.2\.1\.1\.1\.0.*iso\.3\.6\.1\.2\.1\.1\.2\.0.*iso\.3\.6\.1\.2\.1\.1\.3\.0.*iso\.3\.6\.1\.2\.1\.1\.4\.0.*iso\.3\.6\.1\.2\.1\.1\.5\.0.*iso\.3\.6\.1\.2\.1\.1\.6\.0.*iso\.3\.6\.1\.2\.1\.1\.7\.0.*iso\.3\.6\.1\.4\.1\.2021\.14\.1\.1\.2\.0.*iso\.3\.6\.1\.4\.1\.2021\.14\.1\.1\.2\.0"
...
## snmpget - pass - before snmpset  
test_handler "snmpget -t2 -v2c -c public udp6:[$IPADDR]:161 1.3.6.1.4.1.2021.14.1.1.2.0" ".*iso\.3\.6\.1\.4\.1\.2021\.14\.1\.1\.2\.0.*BeforeSet.*"  
## snmpset - pass - after snmpget
test_handler "snmpset -t2 -v2c -c public udp6:[$IPADDR]:161 1.3.6.1.4.1.2021.14.1.1.2.0 s AfterSet" ".*iso\.3\.6\.1\.4\.1\.2021\.14\.1\.1\.2\.0.*AfterSet.*"
## snmpget - pass - after snmpset
test_handler "snmpget -t2 -v2c -c public udp6:[$IPADDR]:161 1.3.6.1.4.1.2021.14.1.1.2.0" ".*iso\.3\.6\.1\.4\.1\.2021\.14\.1\.1\.2\.0.*AfterSet.*"
## snmpset - pass - restore default
test_handler "snmpset -t2 -v2c -c public udp6:[$IPADDR]:161 1.3.6.1.4.1.2021.14.1.1.2.0 s BeforeSet" ".*iso\.3\.6\.1\.4\.1\.2021\.14\.1\.1\.2\.0.*BeforeSet.*"
